...
var _ = Describe("InternalCluster.Cluster", func() {
	Describe("New", func() {
		...
		It("should return an error it can't create a over_client.Client", func() {
			c, err := New(cfg, func(o *Options) {
				o.NewClient = func(config *rest.Config, options over_client.Options) (over_client.Client, error) {
