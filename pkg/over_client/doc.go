...
// Package over_client contains functionality for interacting with Kubernetes API
// servers.
//
// # Clients
//
...
//
// The New function can be used to create a new over_client that talks directly
// to the API server.
//
...
// # Options
//
// Many over_client operations in Kubernetes support options.  These options are
...
//
//	err := someReader.List(context.Background(), &podList, over_client.MatchingLabels{"somelabel": "someval"})
//
// # Indexing
//
...
//
// For instance, a Secret over_controller might have an index on the
