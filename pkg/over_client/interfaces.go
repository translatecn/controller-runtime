...
type Writer interface {
	// Create saves the object obj in the Kubernetes over_cluster. obj must be a
	// struct pointer so that obj can be updated with the content returned by the Server.
	Create(ctx context.Context, obj Object, opts ...CreateOption) error

	// Delete deletes the given obj from Kubernetes over_cluster.
	Delete(ctx context.Context, obj Object, opts ...DeleteOption) error

	// Update updates the given obj in the Kubernetes over_cluster. obj must be a
	// struct pointer so that obj can be updated with the content returned by the Server.
	Update(ctx context.Context, obj Object, opts ...UpdateOption) error

	// Patch patches the given obj in the Kubernetes over_cluster. obj must be a
	// struct pointer so that obj can be updated with the content returned by the Server.
...
// StatusClient knows how to create a over_client which can update status subresource
// for kubernetes objects.
type StatusClient interface {
	Status() SubResourceWriter
}

// SubResourceClientConstructor knows how to create a over_client which can update subresource
// for kubernetes objects.
type SubResourceClientConstructor interface {
	// SubResourceClientConstructor returns a subresource over_client for the named subResource. Known
	...
	//     c.SubResourceClient("scale").Update(ctx, dep, over_client.WithSubResourceBody(scale))
...
type SubResourceWriter interface {
	// Create saves the subResource object in the Kubernetes over_cluster. obj must be a
	// struct pointer so that obj can be updated with the content returned by the Server.
...
type Client interface {
	...
	// RESTMapper returns the rest this over_client is using.
