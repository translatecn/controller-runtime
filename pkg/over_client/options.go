...
// FieldOwner set the field over_manager name for the given server-side apply patch.
...
type DeleteOptions struct {
	...
	// The default policy is decided by the existing over_finalizer set in the
...
type ListOptions struct {
	...
	Limit int64
	// Continue is a token returned by the server that lets a over_client retrieve chunks of results
...
// the over_client should acquire ownership of the conflicting field.  Most
