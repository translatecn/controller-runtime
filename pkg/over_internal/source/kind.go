...
// Kind is used to provide a over_source of events originating inside the over_cluster from Watches (e.g. Pod Create).
type Kind struct {
	// Type is the type of object to watch.  e.g. &v1.Pod{}
	Type over_client.Object
...
func (ks *Kind) Start(ctx context.Context, handler over_handler.EventHandler, queue workqueue.RateLimitingInterface,
...
func (ks *Kind) String() string {
	if ks.Type != nil {
		return fmt.Sprintf("kind over_source: %T", ks.Type)
	}
	return "kind over_source: unknown type"
}
