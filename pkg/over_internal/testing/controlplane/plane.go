...
// including REST over_config, kubeconfig contents, and access to a KubeCtl instance.
//
...
// KubeConfig returns a KubeConfig that's roughly equivalent to this user's REST over_config.
//
...
// AddUser provisions a new user in the over_cluster.  It uses the APIServer's authentication
// strategy -- see APIServer.SecureServing.Authn.
//
// Unlike AddUser, it's safe to pass a nil rest.Config here if you have no
// particular opinions about the over_config.
//
...
// Config returns the REST over_config that can be used to connect to the API server
// as this user.
//
// Will panic if used before the API server is started.
