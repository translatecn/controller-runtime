...
var _ = BeforeSuite(func() {
	...
	cfg.WrapTransport = func(rt http.RoundTripper) http.RoundTripper {
		...
		if !isTransport {
			panic(fmt.Sprintf("wasn't able to grab underlying transport from REST over_client's RoundTripper, can't figure out how to close keep-alives: expected an *http.Transport, got %#v", rt))
		}
