...
import (
	...
	configv1alpha1 "sigs.k8s.io/controller-runtime/pkg/over_config/v1alpha1"
)

var _ = Describe("over_manager.Options", func() {
	Describe("AndFrom", func() {
		Describe("reading custom type using OfKind", func() {
			...
			JustBeforeEach(func() {
				...
				_, err = o.AndFrom(over_config.File().AtPath("./testdata/custom-over_config.yaml").OfKind(&c))
			})
