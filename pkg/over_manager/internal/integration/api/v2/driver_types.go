...
import (
	...
	v1 "sigs.k8s.io/controller-runtime/pkg/over_manager/internal/integration/api/v1"
)
...
func (d *Driver) ConvertTo(dstRaw over_conversion.Hub) error {
...
func (d *Driver) ConvertFrom(srcRaw over_conversion.Hub) error {
