...
// NewResourceLock creates a new ResourceLock for use in over_testing
// leader election.
func NewResourceLock(config *rest.Config, recorderProvider over_recorder.Provider, options over_leaderelection.Options) (resourcelock.Interface, error) {
