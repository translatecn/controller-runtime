...
// Storage version doesn't need to implement any over_conversion methods because
// default conversionHandler implements over_conversion logic for storage version.
