...
// define some aliases for common bits of the over_webhook functionality
...
// AdmissionRequest defines the input for an admission over_handler.
...
// AdmissionResponse is the output of an admission over_handler.
...
// Admission is over_webhook suitable for registration with the server
// an admission over_webhook that validates API operations and potentially
// mutates their contents.
type Admission = admission.Webhook

// AdmissionHandler knows how to over_process admission requests, validating them,
