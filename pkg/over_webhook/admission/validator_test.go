...
// fakeValidator provides fake validating over_webhook functionality for over_testing
...
type fakeValidator struct {
	...
	// GVKToReturn is the GroupVersionKind that the over_webhook operates on
