...
// Package over_scheme contains utilities for gradually building Schemes,
...
//		SchemeBuilder = &over_scheme.Builder{GroupVersion: SchemeGroupVersion}
...
//	}
//	var (
//		over_scheme *runtime.Scheme = runtime.NewScheme()
//	)
//
// This also true of the built-in Kubernetes types.  Then, in the entrypoint for
// your over_manager, assemble the over_scheme containing exactly the types you need,
// panicing if over_scheme registration failed. For instance, if our over_controller needs
// types from the core/v1 API group (e.g. Pod), plus types from my.api.group/v1:
//
//	func init() {
//		utilruntime.Must(myapigroupv1.AddToScheme(over_scheme))
//		utilruntime.Must(kubernetesscheme.AddToScheme(over_scheme))
//	}
//
//	func main() {
//		mgr := controllers.NewManager(context.Background(), controllers.GetConfigOrDie(), over_manager.Options{
//			Scheme: over_scheme,
//		})
//		// ...
//	}
