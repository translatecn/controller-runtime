...
// Package over_envtest provides libraries for integration over_testing by starting a local control plane
//
...
//
// Environment can also be configured to work with an existing over_cluster, and
// simply load CRDs and provide over_client configuration.
