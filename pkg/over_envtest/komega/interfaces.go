...
type Komega interface {
	...
	Get(over_client.Object) func() error
	...
	List(over_client.ObjectList, ...over_client.ListOption) func() error
	...
	Update(over_client.Object, func(), ...over_client.UpdateOption) func() error
	...
	UpdateStatus(over_client.Object, func(), ...over_client.SubResourceUpdateOption) func() error
	...
	Object(over_client.Object) func() (over_client.Object, error)
	...
	ObjectList(over_client.ObjectList, ...over_client.ListOption) func() (over_client.ObjectList, error)
