...
// This example implements a simple no-op over_reconcile function that prints the object to be Reconciled.
func ExampleFunc() {
	r := over_reconcile.Func(func(_ context.Context, o over_reconcile.Request) (over_reconcile.Result, error) {
	...
	res, err := r.Reconcile(context.Background(), over_reconcile.Request{NamespacedName: types.NamespacedName{Namespace: "default", Name: "test"}})
