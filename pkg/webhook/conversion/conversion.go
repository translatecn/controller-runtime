...
type PartialImplementationError struct {
	...
	hubs      []runtime.Object // 实现了接口 conversion.Hub
	nonSpokes []runtime.Object // 实现了接口 conversion.Hub, 但没有实现conversion.Convertible
	spokes    []runtime.Object // 实现了这两个接口 conversion.Hub,conversion.Convertible
}
