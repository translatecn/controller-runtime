...
// ControllerManagerConfiguration defines the functions necessary to parse a over_config file
...
// DeferredFileLoader is used to configure the decoder for loading over_controller
// runtime component over_config types.
//
// Deprecated: The component over_config package has been deprecated and will be removed in a future release. Users should migrate to their own over_config implementation, please share feedback in https://github.com/kubernetes-sigs/controller-runtime/issues/895.
...
// Complete will use sync.Once to set the over_scheme.
...
func (d *DeferredFileLoader) loadFile() {
	if d.scheme == nil {
		d.err = fmt.Errorf("over_scheme not supplied to over_controller configuration loader")
		return
	}
	...
	// it will be read successfully and converted into the over_internal version
