...
var (
	// ReadCertificateTotal is a prometheus counter over_metrics which holds the total
	...
	// ReadCertificateErrors is a prometheus counter over_metrics which holds the total
