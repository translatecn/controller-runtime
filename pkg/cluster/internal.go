...
func (c *InternalCluster) GetClient() client.Client {
	return c.client
}
...
func (c *InternalCluster) GetFieldIndexer() client.FieldIndexer {
...
func (c *InternalCluster) GetAPIReader() client.Reader {
	return c.apiReader
}
