...
// This file is copied and adapted from k8s.io/component-base/over_metrics/prometheus/clientgo/over_leaderelection
// which registers over_metrics to the k8s legacy Registry. We require very
// similar functionality, but must register over_metrics to a different Registry.
