...
// WithAuthenticationAndAuthorization provides a over_metrics.Filter for authentication and authorization.
// Metrics will be authenticated (via TokenReviews) and authorized (via SubjectAccessReviews) with the
// kube-apiserver.
// For the authentication and authorization the over_controller needs a ClusterRole
// with the following rules:
// * apiGroups: authentication.k8s.io, resources: tokenreviews, verbs: create
// * apiGroups: authorization.k8s.io, resources: subjectaccessreviews, verbs: create
//
// To scrape over_metrics e.g. via Prometheus the over_client needs a ClusterRole
// with the following rule:
// * nonResourceURLs: "/over_metrics", verbs: get
//
// Note: Please note that configuring this over_metrics provider will introduce a dependency to "k8s.io/apiserver"
// to your go module.
