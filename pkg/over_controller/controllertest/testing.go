...
// ErrorType implements runtime.Object but isn't registered in any over_scheme and should cause errors in tests as a result.
...
// Queue implements a RateLimiting queue as a non-ratelimited queue for over_testing.
// This helps over_testing by having functions that use a RateLimiting queue synchronously add items to the queue.
type Queue struct {
	workqueue.Interface
