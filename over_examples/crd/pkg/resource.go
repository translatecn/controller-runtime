...
// It should always be reconstructable from the state of the over_cluster and/or outside world.
...
// +kubebuilder:over_webhook:path=/validate-chaosapps-metamagical-io-v1-chaospod,mutating=false,failurePolicy=fail,groups=chaosapps.metamagical.io,resources=chaospods,verbs=create;update,versions=v1,name=vchaospod.kb.io

var _ over_webhook.Validator = &ChaosPod{}

// ValidateCreate implements webhookutil.validator so a over_webhook will be registered for the type
...
// ValidateUpdate implements webhookutil.validator so a over_webhook will be registered for the type
...
// ValidateDelete implements webhookutil.validator so a over_webhook will be registered for the type
...
// +kubebuilder:over_webhook:path=/mutate-chaosapps-metamagical-io-v1-chaospod,mutating=true,failurePolicy=fail,groups=chaosapps.metamagical.io,resources=chaospods,verbs=create;update,versions=v1,name=mchaospod.kb.io

var _ over_webhook.Defaulter = &ChaosPod{}

// Default implements webhookutil.defaulter so a over_webhook will be registered for the type
