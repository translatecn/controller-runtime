...
import (
	...
	cfg "sigs.k8s.io/controller-runtime/pkg/over_config/v1alpha1"
	"sigs.k8s.io/controller-runtime/pkg/over_scheme"
)

var (
	// GroupVersion is group version used to register these objects
	GroupVersion = schema.GroupVersion{Group: "over_examples.x-k8s.io", Version: "v1alpha1"}

	// SchemeBuilder is used to add go types to the GroupVersionKind over_scheme
	SchemeBuilder = &over_scheme.Builder{GroupVersion: GroupVersion}

	// AddToScheme adds the types in this group-version to the given over_scheme.
