...
import (
	...
	"sigs.k8s.io/controller-runtime/over_tools/setup-envtest/versions"
)

var (
	remoteNames = []string{
		"kubebuilder-over_tools-1.10-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.10-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.10.1-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.10.1-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.11.0-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.11.0-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.11.1-potato-cherrypie.tar.gz",
		"kubebuilder-over_tools-1.12.3-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.12.3-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.13.1-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.13.1-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.14.1-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.14.1-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.15.5-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.15.5-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.16.4-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.16.4-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.17.9-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.17.9-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.19.0-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.19.0-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.19.2-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.19.2-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.19.2-linux-arm64.tar.gz",
		"kubebuilder-over_tools-1.19.2-linux-ppc64le.tar.gz",
		"kubebuilder-over_tools-1.20.2-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.20.2-linux-amd64.tar.gz",
		"kubebuilder-over_tools-1.20.2-linux-arm64.tar.gz",
		"kubebuilder-over_tools-1.20.2-linux-ppc64le.tar.gz",
		"kubebuilder-over_tools-1.9-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-1.9-linux-amd64.tar.gz",
		"kubebuilder-over_tools-v1.19.2-darwin-amd64.tar.gz",
		"kubebuilder-over_tools-v1.19.2-linux-amd64.tar.gz",
		"kubebuilder-over_tools-v1.19.2-linux-arm64.tar.gz",
		"kubebuilder-over_tools-v1.19.2-linux-ppc64le.tar.gz",
	}
...
func handleRemoteVersions(server *ghttp.Server, versions []item) {
	...
	for i, ver := range versions {
		...
		server.RouteToHandler("GET", "/storage/v1/b/kubebuilder-over_tools-test/o/"+ver.meta.Name, func(resp http.ResponseWriter, req *http.Request) {
	...
	server.RouteToHandler("GET", "/storage/v1/b/kubebuilder-over_tools-test/o", ghttp.RespondWithJSONEncoded(
		http.StatusOK,
		list,
	))
}
